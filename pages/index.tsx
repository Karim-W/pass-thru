...
export default function Home() {
	...
	if (isSubmited) {
		return <div className=" bg-zinc-800 w-screen h-screen flex flex-col items-center justify-evenly px-2 mb-[2rem] phone:px-[8rem]">
			<Head>
				<title>Pass-thru</title>
				<meta name="description" content="Pass stuff through idk" />
				<link rel="icon" href="/favicon.ico" />
			</Head>
			<h1 className='font-extrabold text-transparent text-8xl mt-[12rem] bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 phone:mt-[0]'>
				Pass-Thru
			</h1>
			<p className='font-bold text-zinc-200 text-2xl text-left w-full phone:text-center phone:text-4xl'>
				Pass stuff through, idk
			</p>
			<div className='flex flex-col items-center justify-start gap-[2rem] w-full mb-[12rem] mt-[1rem] phone:mb-[0rem] phone:gap-4 phone:mt-[0rem]'>
				<p className='font-bold text-transparent text-xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 p-3 phone:text-4xl'>
					Your Pin is: {pin}
				</p>
	...
	return (
		<div className=" bg-zinc-800 w-screen h-screen flex flex-col items-center justify-evenly px-2 mb-[2rem] phone:px-[8rem] ">
			<Head>
				<title>Pass-thru</title>
				<meta name="description" content="Pass stuff through idk" />
				<link rel="icon" href="/favicon.ico" />
